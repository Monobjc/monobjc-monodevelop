...
namespace MonoDevelop.Monobjc
{
	public partial class MonobjcProject
	{
		...
		private MonobjcCodeBehind codeBehind;
		...
		/// </summary>
		internal IEnumerable<SystemAssembly> MonobjcAssemblies {
		...
		/// <summary>
		/// Gets the code behind instance.
		/// </summary>
		/// <value>The code behind instance.</value>
		private MonobjcCodeBehind CodeBehind {
			get { return this.codeBehind ?? (this.codeBehind = new MonobjcCodeBehind (this)); }
		}
	}
}
